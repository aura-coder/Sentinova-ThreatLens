...
from sqlalchemy import (
    Column, String, SmallInteger, DateTime, Enum, ForeignKey, Text, Integer, Boolean
)
...
class AuditLog(Base):
    ...
    actor_username = Column(String, nullable=True)  # Frontend ke liye naya field
    action = Column(String, nullable=False)
    resource_type = Column(String, nullable=False)
    resource_id = Column(String, nullable=True)
    details = Column(JSONB, nullable=True)
    status = Column(String, nullable=True, default="success")  # Frontend ke liye naya field
    created_at = Column(DateTime(timezone=True), server_default=func.now())
